            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8">
                    ...
                    <div className="card-elevated p-8">
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                            <div>
                                <h3 className="text-2xl font-bold text-neutral-900">Frontend Developer</h3>
                                <p className="text-xl text-primary-600 font-semibold">Banff Sea Pte. Ltd.</p>
                                <p className="text-neutral-500">October 2022 – July 2023</p>
                            </div>
                            <div className="mt-4 md:mt-0">
                                <span className="px-4 py-2 bg-orange-100 text-orange-700 rounded-full text-sm font-medium">1 Year</span>
                            </div>
                        </div>

                        <p className="text-neutral-700 mb-6">
                            Led frontend development for Tripkliq, an AI-powered social travel platform. Built interactive travel planning tools and smart hotel experiences serving thousands of users globally.
                        </p>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-primary-500 pl-4">
                                        <h5 className="font-semibold text-neutral-800">Tripkliq – AI-Enhanced Social Travel Platform</h5>
                                        <p className="text-neutral-600 text-sm mb-2">React.js + Redux + Mapbox-based platform for interactive itinerary planning</p>
                                        <ul className="text-sm text-neutral-600 space-y-1">
                                            <li>• Built platform serving <strong>50,000+ active users</strong></li>
                                            <li>• Added social features: follow system, live chat, and AI-generated recommendations</li>
                                            <li>• Served <strong>1000+ daily recommendations</strong> through AI integration</li>
                                            <li>• Built budget tracker with direct bookings and social travel feed</li>
                                            <li>• Processed <strong>$500K+ in bookings</strong> through the platform</li>
                                        </ul>
                                    </div>

                                    <div className="border-l-4 border-secondary-500 pl-4">
                                        <h5 className="font-semibold text-neutral-800">Tripkliq InRoom – Smart Hotel Travel Experience Platform</h5>
                                        <p className="text-neutral-600 text-sm mb-2">QR-based smart concierge system using React.js + AI</p>
                                        <ul className="text-sm text-neutral-600 space-y-1">
                                            <li>• Deployed across <strong>25+ hotels</strong> worldwide</li>
                                            <li>• Enabled guests to access contextual experiences via location-specific QR codes</li>
                                            <li>• Served <strong>10,000+ monthly users</strong> with smart concierge services</li>
                                            <li>• Integrated AI-powered recommendations for personalized guest experiences</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm">React.js</span>
                                    <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm">Redux</span>
                                    <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm">Mapbox</span>
                                    <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm">JavaScript</span>
                                    <span className="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm">AI Integration</span>
                                </div>
                            </div>
                        </div>
                    </div>
